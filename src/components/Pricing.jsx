          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12 sm:mb-16 lg:mb-20"> 
                <h2 className="text-5xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6">
                    <span className="bg-gradient-to-b from-white to-gray-300 bg-clip-text text-transparent">Simple, Transparent </span><br />
                ...
                <p className="text-gray-400 text-base text-1xl sm:text-lg max-w-2xl mx-auto">
                    Choose the plan that best fits your needs and start building today. All plans come with a 14-day free trial.
                </p>
            </div>
                ...
                {plans.map((plan, key) => (
                    <div 
                        ...
                        className={`relative bg-slate-900/50 backdrop-blur-sm border rounded-xl sm:rounded-2xl p-6 sm:p-8 transition-all duration-300 overflow-visible group flex flex-col h-full
                            ${plan.mostPopular 
                                ? "border-blue-500 shadow-2xl shadow-blue-500/15 lg:scale-105" 
                    ...
                    >   
                        ...
                        <div className='text-center mb-6 sm:mb-8'>
                            ...
                            <div className='flex items-baseline justify-center'>
                                <span className='text-2xl sm:text-4xl lg:text-3xl font-bold bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent'>
                                    {plan.price}DH</span>
                                <span className='text-gray-400 ml:1 sm:ml- text-sm sm:text-base'>/Month</span>
                            </div>
                        </div>
                        <ul className='space-y-3 sm:space-y-4 mb-5 sm:mb-8 flex-row'>
            ...
            <div className='mt-8 sm:mt-12 text-center'>
                <p className='text-gray-400 text-base text-xl'>
                    Need a custom plan ? 
                    <a href="contact" className='text-blue-400 hover:text-blue-300'> Contact our sales team</a>
                </p>
            </div>
          </div>
        </section>
